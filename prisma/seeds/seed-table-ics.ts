...
export async function seedIcs() {
    ...
    const rawData = [
        ...
        { districtCode: '1407', districtName: 'Rokan Hulu', code: 'ICS-1407-09', fid: 'CTG', abbreviation: 'Citra Gemilang', name: 'Citra Gemilang' },
        { districtCode: '1407', districtName: 'Rokan Hulu', code: 'ICS-1407-10', fid: 'TSS', abbreviation: 'Kelompok Tani Sungai Singkumeh', name: 'Kelompok Tani Sungai Singkumeh' },
